export function getMemoryElements(documentRef = document) {
  return {
    ...
    memoryScoresWrapper: documentRef.getElementById('memoryScoresWrapper'),
    turnTimerBar: documentRef.getElementById('turnTimerBar'),
    btnUseHint: documentRef.getElementById('btnUseHint'),
